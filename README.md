...
- `agb.html` – Terms and Conditions (German) – as of June 2026
...
The in-app Terms of Service (AGB) use `AGBConfig.currentVersion` (currently `"2026-06"`) to detect changes.
...
The current AGB version **`2026-06`** introduced:
